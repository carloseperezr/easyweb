    ...
    <div className={`${classes.cardsContainer}`}>
      <Slide direction="up" triggerOnce={true}>
        ...
        <BenefitCard
          ...
          title={"Correcciones mensuales"}
          text={
            "En nuestro compromiso por garantizar tu satisfacción continua, ofrecemos correcciones mensuales en tu página web. Nos aseguramos de que tu sitio esté siempre actualizado y funcione de manera óptima, adaptándonos a tus necesidades en constante evolución."
          }
        />
      </Slide>
      <Slide direction="up" triggerOnce={true}>
        ...
        <BenefitCard
          ...
          text={
            "Sabemos lo importante que es manejar tus recursos de manera eficiente. Nos comprometemos a ofrecerte servicios de alta calidad sin salirte de tu presupuesto. Trabajamos contigo para encontrar soluciones rentables que se ajusten a tus necesidades y objetivos comerciales"
          }
        />
      </Slide>
      <Slide direction="up" triggerOnce={true}>
